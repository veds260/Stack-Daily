...
export default function ShareableCard({ xProfile, name }: ShareableCardProps) {
  ...
  return (
    <div className="w-full max-w-lg">
      {/* Glass card container - compact and minimal */}
      <motion.div
        ref={cardRef}
        ...
        className="relative w-full bg-zinc-950/50 backdrop-blur-xl border border-zinc-800/50 rounded-3xl p-10 md:p-12 transition-all duration-500 hover:border-zinc-700/50 hover:bg-zinc-900/30"
      >
        ...
        <div className="text-center">
          ...
          {/* Name - smaller and lighter */}
          <h1 className="text-white text-2xl md:text-3xl font-light mb-6 tracking-tight">
            {name}
          </h1>
      ...
      {/* Minimal buttons - subtle and clean */}
      <div className="flex gap-3 mt-6">
        <motion.button
          ...
          onClick={handleCopy}
          disabled={isCopied}
          className="px-5 py-3 bg-white text-black rounded-full text-sm font-medium hover:bg-zinc-100 transition-colors disabled:bg-green-500 disabled:text-white flex items-center justify-center gap-2"
        >
          {isCopied ? (
            <>
        ...
        <motion.button
          ...
          className="px-5 py-3 bg-zinc-900 text-white rounded-full text-sm font-medium hover:bg-zinc-800 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {isDownloading ? (
            <>
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.99 }}
          className="px-5 py-3 bg-zinc-900 text-white rounded-full text-sm font-medium hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
        >
